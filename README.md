...
Le GPS intégré au T-Beam permet, une fois la balise décodée, d'avoir un cap/distance entre le T-Beam et la balise (si celle-ci comporte un GPS). Pour le reste, je vous laisse découvrir les notes de F1GHO ainsi que les images qui se suffisent à elles-mêmes.
