...
Ce programme décode toutes les infos et celle-ci sont disponibles sur 3 sorties:
...
On peut aussi, en appuyant sur le "bouton 38" du TTGO, lancer un decodage de test interne.
